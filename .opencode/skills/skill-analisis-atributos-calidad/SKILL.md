...
- **La presencia de una métrica técnica o cuantitativa NO define la importancia.** Que el enunciado exija una meta numérica o límite estricto (ej. "2 segundos", "99.9% de uptime", "menos de 500 ms") solo completa el *Response Measure* en el escenario. Si el requisito solo da la métrica pero no califica su importancia (no dice "crítico", "esencial", "afecta directamente al negocio", etc.), la importancia debe ser **No especificado**. La métrica es un dato técnico del escenario, no una declaración de valor para el negocio.
...
**Nota sobre la priorización:** La escala H/M/L proviene de la bibliografía (sección 19.4), pero los valores concretos deben derivarse del enunciado. El enunciado puede fijar la **importancia** solo si usa lenguaje de criticidad o impacto explícito (p. ej. "es crítico", "es un riesgo muy alto", "afecta directamente al negocio", "es el propósito central del sistema"). La mera palabra **"debe" NO es indicación de importancia High**: solo declara que es un requisito. **Tampoco la presencia de una métrica técnica o cuantitativa** (ej. "2 segundos", "99.9% de uptime") define la importancia: la métrica completa el *Response Measure*, no la prioridad. Si el enunciado no expresa criticidad explícita para ese atributo, la importancia es **No especificado**. La dificultad será normalmente **No especificado**, y solo se asigna un valor cuando el enunciado describe explícitamente la complejidad del logro del objetivo.
